...
def generate_launch_description():
    parameters = json.loads('{"joint":"693eef08e75a778c84020134","control_mode":"position","limit.lower_position":0,"limit.upper_position":360,"limit.position_step":null,"limit.max_effort":0,"limit.effort_step":0.1,"limit.max_velocity":0,"limit.velocity_step":0.1}')
    ...
    env = {
        "POLYFLOW_NODE_ID": "693eefece75a778c8402014e",
